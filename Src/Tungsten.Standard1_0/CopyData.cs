...
namespace W.Interprocess
{
    ...
    public sealed class CopyData<TMessage> : CopyData
    {
        ...
        protected override void OnWM_COPYDATA(COPYDATASTRUCT cds)
        {
            ...
            var item = CopyDataStruct.AsBytes(cds).FromBytes<TMessage>();
    ...
    /// <summary>
    /// Adds logging via WM_COPYDATA
    /// </summary>
    public class CopyDataLogger : Logging.CustomLogger
    {
        private CopyData _cd;
        ...
        {
            var logMessage = FormatLogMessage(category, message);
            _cd.Send(logMessage.AsBytes());
        }
        /// <summary>
        /// Constructs a new CopyDataLogger
        /// </summary>
