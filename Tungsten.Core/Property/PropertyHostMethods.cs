...
namespace W
{
    ...
    public static class PropertyHostMethods
    {
        ...
        {
            var fieldInfos = @this.GetType().GetTypeInfo().GetFields(BindingFlags.FlattenHierarchy | BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic).ToList();
            foreach (var fieldInfo in fieldInfos)
            {
               SetOwner(fieldInfo, @this);
            }

            var propertyInfos = @this.GetType().GetTypeInfo().GetProperties(BindingFlags.FlattenHierarchy | BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic).ToList();
