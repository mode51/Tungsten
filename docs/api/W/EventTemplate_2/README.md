EventTemplate&lt;TEventArg1, TEventArg2> Class
==============================================
...
---------------------
[System.Object][1]  
  **W.EventTemplate<TEventArg1, TEventArg2>**  
...
The **EventTemplate<TEventArg1, TEventArg2>** type exposes the following members.
...
                 | Name                                          | Description                                                                       
---------------- | --------------------------------------------- | --------------------------------------------------------------------------------- 
![Public method] | [EventTemplate&lt;TEventArg1, TEventArg2>][3] | Initializes a new instance of the **EventTemplate<TEventArg1, TEventArg2>** class 
