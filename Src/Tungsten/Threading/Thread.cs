...
//#else
    ...
    ///// A thread wrapper which makes multi-threading easier
    ///// </summary>
    ///// <typeparam name="TCustomData"></typeparam>
    //public class Thread<TCustomData> : Thread
    //{
    //    /// <summary>
    //    /// Custom data to be passed into the thread 
    //    /// </summary>
    //    public Lockable<TCustomData> CustomData { get; }
    //    /// <summary>
    ...
    //    /// <returns></returns>
    //    public Thread(Action<TCustomData, CancellationTokenSource> action, 
    ...
    //    {
    //        Action = action;
    //        CustomData = new Lockable<TCustomData>(customData);
    //    }
    ...
    //    /// <param name="customData">The custom data to pass to the thread (Action)</param>
    //    /// <returns></returns>
    //    public static W.Threading.Thread<TCustomData> Create(Action<TCustomData, CancellationTokenSource> action, Action<bool, Exception> onComplete = null, CancellationTokenSource cts = null, TCustomData customData = default(TCustomData))
    //    {
    //        var thread = new W.Threading.Thread<TCustomData>(action, onComplete, customData, cts);
    //        return thread;
    //    }
    //}
//#endif
