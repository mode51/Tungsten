...
namespace W.IO.Pipes
{
    ...
    public partial class PipeClient : IDisposable
    {
        ...
        private W.Threading.Lockers.SemaphoreSlimLocker StreamLock = new Threading.Lockers.SemaphoreSlimLocker(1, 1);
    ...
    public partial class PipeClient
    {
        ...
        public static async Task PostAsync(byte[] bytes, bool useCompression, string serverName, string pipeName, int msTimeout)
        {
        ...
        /// <param name="msTimeout">The number of milliseconds to wait to establish a connection</param>
        /// <returns>The Task associated with this action</returns>
        public static async Task<byte[]> RequestAsync(byte[] bytes, bool useCompression, string serverName, string pipeName, int msTimeout)
        {
            var connectionResult = Create(serverName, pipeName, msTimeout);
            if (connectionResult.Result != null)
            {
        ...
        /// <param name="msTimeout">The number of milliseconds to wait to establish a connection</param>
        /// <returns>The Task associated with this action</returns>
        public static async Task<TType> RequestAsync<TType>(TType item, bool useCompression, string serverName, string pipeName, int msTimeout) where TType : class
        {
            var connectionResult = Create(serverName, pipeName, msTimeout);
            if (connectionResult.Result == null)
