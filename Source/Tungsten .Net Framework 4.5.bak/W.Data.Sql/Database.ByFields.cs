    ...
    public partial class Database
    {
        public class ByFields
        {
            ...
            public static IDbCommand Insert<T>(T obj, IDbConnection connection)
            {
                ...
                foreach (Data.Attributes.TableAttribute tableAttribute in obj.GetType().GetCustomAttributes(typeof(Data.Attributes.TableAttribute), true))
                {
