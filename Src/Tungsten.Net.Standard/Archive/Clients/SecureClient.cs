...
namespace W.Net
{
    #region this one works, but we'll try to use some inheritance
    ...
    public class SecureClient<TDataType> : Client<TDataType>, W.Net.Sockets.ISecureSocket where TDataType : class
    {
        private W.Encryption.RSA _rsa;
        ...
        /// </summary>
        public bool IsSecure => IsConnectedResetEvent.IsSet;
        ...
        //public async System.Threading.Tasks.Task<bool> ConnectAsync(string remoteAddress, int remotePort)
        //{
        //    return await Socket.ConnectAsync(remoteAddress, remotePort).ContinueWith(task => { return WaitForConnected(1000); });
        //}
        //public async System.Threading.Tasks.Task<bool> ConnectAsync(IPAddress remoteAddress, int remotePort)
        //{
        //    return await Socket.ConnectAsync(remoteAddress, remotePort).ContinueWith(task => { return WaitForConnected(1000); });
        //}
