    ...
    public partial class Database
    {
        public class ByFields
        {
            internal static string GetSelectStatement<T>()
            {
                ...
                select += string.Join(",", from f in fields select "[" + f.Attributes.NamedColumn.Column + "]");
            ...
            public static IDbCommand Insert<T>(T obj, IDbConnection connection)
            {
                ...
                foreach (SQL.Attributes.TableAttribute tableAttribute in obj.GetType().GetCustomAttributes(typeof(SQL.Attributes.TableAttribute), true))
                {
