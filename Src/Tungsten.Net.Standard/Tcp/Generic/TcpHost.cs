...
namespace W.Net
{
    public static partial class Tcp
    {
        public static partial class Generic
        {
            ...
            {
                public EventTemplate<TcpHost<TMessage>, TcpClient<TMessage>, TMessage> MessageReceived { get; private set; } = new EventTemplate<TcpHost<TMessage>, TcpClient<TMessage>, TMessage>();
                ...
                protected override void OnBytesReceived(IClient client, byte[] bytes)
                {
                    ...
                    MessageReceived.Raise(this, (TcpClient<TMessage>)client, message);
                }
                public TcpHost()
                {
