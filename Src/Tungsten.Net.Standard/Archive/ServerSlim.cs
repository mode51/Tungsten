...
namespace W.Net
{
    ...
    public class ServerSlim<TClientType> : IDisposable where TClientType : ISocketClient// ClientSlim
    {
        ...
        public void Start(IPEndPoint ipEndPoint, int backLog = -1)
        {
            try
            {
    ...
    public class SecureServerSlim<TClientType> : ServerSlim<TClientType> where TClientType : ISocketClient
    {
