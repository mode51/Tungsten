...
namespace W.InvokeExtensions
{
    ...
    public static class InvokeExtensions
    {
        ...
        {
            Windows.ApplicationModel.Core.CoreApplication.MainView.CoreWindow.Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, () => action?.Invoke()).GetResults();
        }
        /// <summary>
...
#elif NETSTANDARD1_0 || NETSTANDARD1_1 || NETSTANDARD1_2 || NETSTANDARD1_3 || WINDOWS_PORTABLE || NETCOREAPP1_0 || NETCOREAPP1_1
        /// <summary>
        /// Runs the provided Action on the UI thread
        /// </summary>
