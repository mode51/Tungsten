...
namespace W.Net.RPC
{
    ...
    public class Client : IDisposable
    {
        ...
        public W.EventTemplate<Client, bool> ConnectionStatus { get; } = new EventTemplate<Client, bool>();
            ...
            try
            {
                ...
                if (!_client?.Socket?.Connected ?? true)
                {
                    ...
                    if (_client == null)
                    {
                        ...
                        _client.Connected += (o) => { ConnectionStatus.Raise(this, true); };
                        _client.Disconnected += (o) => { ConnectionStatus.Raise(this, false); };
                    }
