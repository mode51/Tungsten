...
namespace W
{
    ...
    //public delegate void PropertyValueChangingDelegate<TOwner, TValue>(TOwner owner, TValue oldValue, TValue newValue, ref bool cancel);
    ///// <summary>
    ...
    //public delegate void PropertyValueChangedDelegate<TOwner, TValue>(TOwner sender, TValue oldValue, TValue newValue);
    ///// <summary>
    ...
    ///// <param name="oldValue">The previous value</param>
    ///// <param name="newValue">The new value</param>
    //public delegate void OnValueChangedDelegate<TOwner, TValue>(TOwner owner, TValue oldValue, TValue newValue);
    ...
    //public abstract class PropertyBase<TOwner, TValue> : PropertySlim<TValue>, IDisposable, IProperty<TValue> where TOwner : class
    //{
    ...
    //    private readonly LockableSlim<bool> _isDirty = new LockableSlim<bool>();
    ...
    //    #region Value
    //    private readonly LockableSlim<TValue> _value = new LockableSlim<TValue>(default(TValue));
    //    /// <summary>
